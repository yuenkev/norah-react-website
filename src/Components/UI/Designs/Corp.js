  ...
  return (
    <div className={classes.corp}>
      ...
      <Fade cascade="true" duration={500} triggerOnce="true">
        <p>
          I worked with the Speaker and Corporate Relations departments to
          design a corporate package that was sent out and pitched to companies
          large and small for both monetary and in-kind sponsorships.
        </p>
        <p>
